...
type ListPeopleRequset struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *ListPeopleRequset) Reset() {
	*x = ListPeopleRequset{}
	if protoimpl.UnsafeEnabled {
...
func (x *ListPeopleRequset) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListPeopleRequset) ProtoMessage() {}

func (x *ListPeopleRequset) ProtoReflect() protoreflect.Message {
	mi := &file_addressbook_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListPeopleRequset.ProtoReflect.Descriptor instead.
func (*ListPeopleRequset) Descriptor() ([]byte, []int) {
...
func (x *ListPeopleResponse) GetBooks() []*AddressBook {
	if x != nil {
		return x.Books
	}
	return nil
...
var file_addressbook_proto_rawDesc = []byte{
	...
	,
}
...
var file_addressbook_proto_goTypes = []interface{}{
	...
	(*ListPeopleRequset)(nil),     // 3: api.ListPeopleRequset
	(*ListPeopleResponse)(nil),    // 4: api.ListPeopleResponse
	(*Person_PhoneNumber)(nil),    // 5: api.Person.PhoneNumber
	(*timestamppb.Timestamp)(nil), // 6: google.protobuf.Timestamp
}
var file_addressbook_proto_depIdxs = []int32{
	5, // 0: api.Person.phones:type_name -> api.Person.PhoneNumber
	6, // 1: api.Person.last_updated:type_name -> google.protobuf.Timestamp
	1, // 2: api.AddressBook.people:type_name -> api.Person
	2, // 3: api.ListPeopleResponse.books:type_name -> api.AddressBook
	0, // 4: api.Person.PhoneNumber.type:type_name -> api.Person.PhoneType
	3, // 5: api.AddressBookService.ListAllAddressBook:input_type -> api.ListPeopleRequset
	4, // 6: api.AddressBookService.ListAllAddressBook:output_type -> api.ListPeopleResponse
...
func file_addressbook_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_addressbook_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ListPeopleRequset); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
